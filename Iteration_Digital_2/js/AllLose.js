...
BasicGame.AllLose = function (game) {
    ...
    */
    ...
    this.lines = [
        ...
        "Actually, no...\n(ENTER to continue)",
        "You were not the traitor.\n(ENTER to continue)",
        "And yet, you decided to leave your partner behind...\n(ENTER to continue)",
        "And for what?",
        "You might gotten out, but you lost the game.",
...
BasicGame.AllLose.prototype = {
    ...
    create: function () {
        ...
        this.music1 = this.add.audio('loss1',0.4, true);
        this.boo1= game.add.audio('loss2', 0.8, true);
        this.music1.play();
        this.boo1.play();
