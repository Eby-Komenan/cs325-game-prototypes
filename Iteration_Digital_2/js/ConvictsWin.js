...
BasicGame.ConvictsWin = function (game) {
    ...
    */
    ...
    this.lines = [
        "You were able to trust each other...\n(ENTER to continue)",
        "You may have been able to identify the traitor.\n(ENTER to continue)",
        "Now you are both out and the traitor has failed in their mission.\n(ENTER to continue)",
        "The traitor has lost and you win!\n(ENTER to continue)",
...
BasicGame.ConvictsWin.prototype = {
