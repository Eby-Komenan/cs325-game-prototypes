...
BasicGame.P1Riddle = function (game) {
...
BasicGame.P1Riddle.prototype = {
    ...
    quitGame: function () {
        this.state.start('P2Riddle',true, false, this.save, this.noRepeats);
    }
