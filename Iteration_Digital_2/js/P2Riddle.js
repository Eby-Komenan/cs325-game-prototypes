...
BasicGame.P2Riddle = function (game) {
...
BasicGame.P2Riddle.prototype = {
    ...
    quitGame: function () {
        this.state.start('P3Riddle',true, false, this.save, this.noRepeats);
    }
